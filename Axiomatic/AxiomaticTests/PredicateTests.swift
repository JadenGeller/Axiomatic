...
class PredicateTests: XCTestCase {
    func testUnifyPredicate() {
        ...
        // 100(a, 0, 1).
        let p1 = Term(name: 100, arguments: [.Variable(a), .Constant(Term(atom: 0)), .Constant(Term(atom: 1))])
        // 100(-1, 0, b).
        let p2 = Term(name: 100, arguments: [.Constant(Term(atom: -1)), .Constant(Term(atom: 0)), .Variable(b)])
    ...
    func testUnifyPredicateNested() {
        let a = Binding<Term<Int>>()
        // 100(10(1)).
        let p1 = Term(name: 100, arguments: [.Constant(Term(name: 10, arguments: [.Constant(Term(atom: 1))]))])
        // 100(10(a)).
        let p2 = Term(name: 100, arguments: [.Constant(Term(name: 10, arguments: [.Variable(a)]))])
    ...
    func testUnifyPredicateNestedVariable() {
        let a = Binding<Term<Int>>()
        let b = Binding<Term<Int>>()
        let p1 = Term(name: 100, arguments: [.Constant(Term(name: 10, arguments: [.Variable(a)]))])
        let p2 = Term(name: 100, arguments: [.Constant(Term(name: 10, arguments: [.Variable(b)]))])
    ...
    func testUnifyPredicateMismatchName() {
        let p1 = Term(name: 100, arguments: [.Constant(Term(atom: 10))])
        let p2 = Term(name: 101, arguments: [.Constant(Term(atom: 10))])
    ...
    func testUnifyPredicateMismatchArity() {
        let p1 = Term(name: 100, arguments: [.Constant(Term(atom: 10))])
        let p2 = Term(name: 100, arguments: [.Constant(Term(atom: 10)), .Constant(Term(atom: 10))])
    ...
    func testCopy() {
        ...
        try! Term.unify(a, Term<Int>(name: 100, arguments: [.Constant(Term(atom: 5))]))
        ...
        try! Term.unify(aa, Term<Int>(name: 100, arguments: [.Constant(Term(atom: -5))]))
        XCTAssertEqual(5, a.arguments[0].value?.name)
        XCTAssertEqual(5, b.arguments[0].value?.name)
